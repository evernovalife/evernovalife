...
/* checkoutLimiter counts per IP across crypto/zelle/ach, and every request in
   this file comes from 127.0.0.1 in one process — so without a reset, this
   file's own volume of test orders would trip a control aimed at automated
   checkout abuse, not a legitimate run. */
