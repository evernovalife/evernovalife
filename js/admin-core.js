...
(function (window, document) {
  ...
  var ICONS = {
    ...
    // A bank front — roof, four columns, a step — for the Bank (ACH) view.
    bank: '<path d="M3 9.5 12 4l9 5.5"/><path d="M4 10.5h16"/><path d="M6 10.5v7"/><path d="M10 10.5v7"/><path d="M14 10.5v7"/><path d="M18 10.5v7"/><path d="M3 20h18"/>',
  ...
  var NAV = [
    ...
    { key: 'ach', href: 'admin.html#ach', label: 'Bank (ACH)', icon: 'bank', tally: 'navAch' },
