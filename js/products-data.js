...
/* ============================================================
   PRODUCT_PAGES — id → the static page that SKU lives on.

   Every seeded SKU gets its own crawlable HTML file, generated by
   tools/build-seo.js from the catalog above. The old one-page-serves-
   everything URL (product.html?id=N) still works and still resolves to
   the same product, but it is no longer the address we publish: nine
   SKUs sharing one URL meant one title, one description and one
   canonical for the whole catalog, so none of them could rank.

   A product added in admin has no entry here and keeps the query URL —
   productHref() in main.js falls back to it. Re-run the generator after
   adding, renaming or repricing a seeded SKU; a stale baked page is
   worse than none.
   ============================================================ */
/* BEGIN product-pages · generated by tools/build-seo.js — do not edit by hand */
const PRODUCT_PAGES = {
  1: 'retatrutide-10mg',
  2: 'bacteriostatic-water-10ml',
  3: 'ghk-cu-copper-peptide-50mg',
  4: 'tesamorelin-ipamorelin-blend-10mg-3mg',
  5: 'mots-c-10mg',
  6: 'bpc-157-tb-500-blend-20mg',
  7: 'klow-blend-80mg',
  8: 'nad-plus-500mg',
  9: 'hgh-36-iu'
};
